...
const (
	...
	UpdateProfileName                   = "UPDATE accounts SET name = ? WHERE account_id = ?"
	UpdateProfileSurName                = "UPDATE accounts SET surname = ? WHERE account_id = ?"
	UpdateProfileNameAndSurName         = "UPDATE accounts SET name = ? , surname = ? WHERE account_id = ?"
